...
//
final public class SchemeAlreadyExistsHelper
{
    public static void
    insert(Any any, SchemeAlreadyExists val)
    {
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/URLRegistry/SchemeAlreadyExists:1.0";
    }
    ...
    public static void
    write(OutputStream out, SchemeAlreadyExists val)
    {
        out.write_string(id());
    }
}
