...
enum AlternateLatinCodec implements ImmutableCharCodec {
    ...
    ISO_LATIN_5(CharSequences.CS_8859_5),
    ISO_LATIN_7(CharSequences.CS_8859_7),
    ISO_LATIN_9(CharSequences.CS_8859_9);

    private interface CharSequences {
        char[] CS_8859_2 = {
    ...
    /**
     * @param mapping A subsequence of java characters from the named char set:
     *                the first element is an anchor, and represents a
     *                codepoint unchanged by this mapping. This first element
     *                is therefore also the offset between the index and the
     *                represented codepoint. <br>
     *                For a given <code>int codepoint</code> the mapping from
     *                the named char set to Java is given by:<br>
     *                <code>int offset = mapping[0];</code><br>
     *                <code>char javaChar = mapping[codepoint - offset];</code>
     */
    AlternateLatinCodec(char[] mapping) {
        this.mapping = mapping;
    }

    private char convertToJava(char v) {
        final int offset = mapping[0];
