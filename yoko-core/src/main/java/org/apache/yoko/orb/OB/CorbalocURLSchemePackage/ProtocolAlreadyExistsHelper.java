...
//
final public class ProtocolAlreadyExistsHelper
{
    public static void
    insert(Any any, ProtocolAlreadyExists val)
    {
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/CorbalocURLScheme/ProtocolAlreadyExists:1.0";
    }
    ...
    public static void
    write(OutputStream out, ProtocolAlreadyExists val)
    {
        out.write_string(id());
    }
}
